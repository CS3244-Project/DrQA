...
#python scripts/retriever/eval.py data/datasets/SQuAD.txt --model saved_tfidf/squad-tfidf-ngram=3-hash=16777216-tokenizer=simple.npz  --doc-db saved_db/squad.db --n-docs 5
#python scripts/retriever/eval.py data/datasets/SQuAD.txt --model saved_tfidf/squad-tfidf-ngram=3-hash=16777216-tokenizer=simple.npz  --doc-db saved_db/squad.db --n-docs 1
