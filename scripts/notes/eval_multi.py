...
def eval_tfidf(dataset, model, doc_db, tokenizer, n_docs, num_workers, match):
    ...
    ranker = retriever.get_class('tfidf')(tfidf_path=model, strict=False)

    logger.info('Ranking...')
    closest_docs = ranker.batch_closest_docs(
        questions, k=n_docs, num_workers=num_workers
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_depts', type=int)
