...
python scripts/notes/eval_multi.py depts/dept_{}.txt --model depts/tfidf/dept_{}-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz  --doc-db depts/db/dept_{}.db --n-docs 1 --num_depts 20
python scripts/notes/eval_multi.py depts/dept_{}.txt --model depts/tfidf/dept_{}-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz  --doc-db depts/db/dept_{}.db --n-docs 5 --num_depts 20
...
python scripts/retriever/eval.py depts/full.txt --model depts/tfidf/full-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz  --doc-db depts/db/full.db --n-docs 15
